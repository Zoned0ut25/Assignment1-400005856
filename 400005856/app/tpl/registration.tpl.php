...
<body>
    <main class="h-full ww-full grid lg:grid-cols-2">
        ...
        <div class="flex justify-center items-center bg-teal-500 p-6">
            ...
            <form method="post" action="register.php" class="max-w-md w-full bg-white border rounded-md flex flex-col gap-y-2 p-4">
                            <h1 class="text-xl font-[500]">Register new user</h1>
                            ...
                            <div class="flex gap-x-2">
                                <button name="register" class="text-sm bg-slate-950 rounded px-6 py-2 text-white font-[500]" type="submit">Register</button>
